...
class TestPieces(TestCase):
    ...
    def test_king_updates_position_internally(self):
        ...
        self.board.click(self.board.get_coordinates_from_square_nr(3), 'n', self.WIN)  # click needed to fill move_list
    ...
    def test_king_moves_when_in_check(self):
        ...
        self.board.click(self.board.get_coordinates_from_square_nr(75), 'n', self.WIN)  # click needed to fill move_list
        # illegal move
        self.board.make_move(self.board.get_coordinates_from_square_nr(89), self.WIN)
        self.assertTrue(self.board.get_piece(75) == test_piece)
        self.assertTrue(self.board.get_piece(89) is None)
        # legal move
        self.board.make_move(self.board.get_coordinates_from_square_nr(90), self.WIN)
